            ...
            <div class="row h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    ...
                    }else if($_SESSION['email']=="admin@gmail.com"&&$_SESSION['password']=='admin1'&&isset($_SESSION['login_status']))
                    {
                        ...
                        echo  " <table border='2px' bordercolor='red' style='font-size:20px;margin-left:-50px;'><tr style='color:green;'><th>Name</th><th>Email</th><th>School</th><th>10th %</th><th>12th %</th><th>University</th><th>Graduation Course</th><th>HTML</th><th>CSS</th><th>JAVA</th><th>Bootstarp</th><th>C</th><th>status</th></tr> ";
                        while($row = $result->fetch_array(MYSQLI_ASSOC))

                            {
                                echo "<tr style='color:white;'><td>" . $row["First Name"]. " " . $row["Last Name"]. "</td><td>".$row["Email"]."</td><td>".$row["School"]."</td><td>".$row['10th %']."</td><td>".$row['12th %']."</td><td>".$row['University']."</td><td>".$row['Graduation Course']."</td><td>".$row['html']."</td><td>".$row['css']."</td><td>".$row['java']."</td><td>".$row['bootstrap']."</td><td>".$row['c']."</td><td>".$row['status']."</td></tr>";
                            }
