...
{
        $pass="Select * from User where Email='$emailCheck'";
      ...
      $sql="INSERT INTO `User`.`User` (`First Name`, `Last Name`,`Email`, `School`,`10th %`, `12th %`,`University`, `Graduation Course`,`html`, `css`,`java`, `bootstrap`,`c`, `Password`,`token`,`status`) VALUES ( '$firstname','$lastname','$emailCheck', '$school', '$per10', '$per12', '$university', '$graduation', '$html', '$css', '$java', '$bootstrap', '$c', '$password','$token','active')"; 
